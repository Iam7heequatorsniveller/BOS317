...
public class Standard {
	@Id
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="standardGenerator")
	@SequenceGenerator(name="standardGenerator",sequenceName="seq_standard", initialValue=100, allocationSize=1)
	@Column(name = "C_ID")
