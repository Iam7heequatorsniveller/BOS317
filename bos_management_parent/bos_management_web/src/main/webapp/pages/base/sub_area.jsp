	...
	<head>
		...
		<script type="text/javascript">
			function doAdd(){
				//通过js方式创建下拉列表
				$('#areaId').combobox({ 
					url:'${pageContext.request.contextPath}/areaAction_findAll.action', 
					valueField:'id', 
					textField:'text',
					mode:'remote'
				});
			...
			function doShowChart(){
				...
				//发送请求获取 饼状图要求json数据格式 
				$.post("${pageContext.request.contextPath}/subAreaAction_showChart.action",null,function(data){
				...
				<form id="subareaForm" method="post" action="${pageContext.request.contextPath}/subareaAction_save.action">
					<table class="table-edit" width="80%" align="center">
						...
						<tr>
							<td>选择区域</td>
							<td>
								<input type="text" name="area.id" id="areaId">
